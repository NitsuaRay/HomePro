        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('available.personnel')" :active="request()->routeIs('available.personnel')">
                        {{ __('Available Personnel') }}
                    </x-nav-link>
                    <x-nav-link :href="route('submit.booking')" :active="request()->routeIs('submit.booking')">
                        {{ __('Booking Lists') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                    ...
                    <x-slot name="trigger">
                        <div class="flex gap-2">
                            ...
                            <div class="flex justify-center items-center w-12 h-12 rounded-full overflow-hidden">
                                <img src="{{ asset('storage/' . Auth::user()->photo) }}" alt="User Profile Picture" class="object-cover object-center w-full h-full">
                            </div>
                            @else
                ...
                <div class="flex items-center ">
                    ...
                    <a class="px-3 py-1 bg-blue-900 text-white  rounded text-sm flex gap-2 items-center" href="{{ route('profile.edit') }}">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('submit.booking')">
                    {{ __('Booking Lists') }}
                </x-responsive-nav-link>
