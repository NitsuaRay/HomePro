<x-guest-layout>
    ...
    <form method="POST" action="{{ route('personnel.login') }}">
        ...
        <p class="font-black sm:text-xl text-md text-blue-900 mb-3">Login Form for Service Personnel</p>
        ...
        <div class="flex items-center justify-between mt-5">
            @if (Route::has('password.request'))
                <a class="underline text-sm text-gray-600 hover:text-blue-900 rounded-md focus:outline-none"
                    href="{{ route('personnel.register') }}">
        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <button
                ...
                text-white dark:text-white uppercase tracking-widest shadow-sm hover:bg-amber-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-amber-700 disabled:opacity-25 transition ease-in-out duration-150"><a
                    href="{{ route('login') }}">Login as Homeowner</a></button>
        </div>
    </form>
</x-guest-layout>
