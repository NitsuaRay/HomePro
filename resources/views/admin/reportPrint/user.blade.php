<div class="sm:ml-64">
    ...
    <div class="max-w-7xl mx-auto px-2 mt-2">
        <div class="flex justify-between items-center">
            @include('adminModal.searhFilterPrint')
        </div>
        <div class="overflow-x-auto mt-2">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
                <form class="flex gap-2 flex-col" action="{{ route('generate.pdfUsers') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="{{ $key % 2 == 0 ? 'bg-white' : 'bg-gray-100' }} border-b">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                        <input name="selected_booking_id[]" value="{{ $users->id }}" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
