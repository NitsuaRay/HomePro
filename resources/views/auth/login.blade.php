<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <p class="font-black sm:text-xl text-md text-blue-900 mb-3">Login Form for Homeowner</p>
        <!-- User Type -->
        <!-- Email Address -->
        @if (Session::has('success'))
            <div id="toast-successL"
                ...
                <button type="button"
                    ...
                    data-dismiss-target="#toast-successL" aria-label="Close">
        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <button
                ...
                text-white dark:text-white uppercase tracking-widest shadow-sm hover:bg-amber-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-amber-700 disabled:opacity-25 transition ease-in-out duration-150"><a
                    href="{{ route('personnel.login') }}">Login as Service
                    Personnel</a></button>
        </div>
    </form>
</x-guest-layout>
