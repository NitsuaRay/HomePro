<div id="popup-modal-{{ $booking->id }}" tabindex="-1"
    ...
    <div class="relative w-full max-w-md mx-auto my-8">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button data-modal-hide="popup-modal-{{ $booking->id }}" type="button"
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to cancel
                    this booking?</h3>
                <form id="rejectForm" action="{{ route('bookings.reject', ['id' => $booking->id]) }}" method="POST">
                    @csrf
